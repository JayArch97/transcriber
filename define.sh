...
examples=$(curl "https://freedictionaryapi.com/api/v1/entries/de/$word?translations=true&pretty=true" | jq '.entries[].senses[].examples')

notify-send -h string:bgcolor:#FFFFFF -h string:fgcolor:#000000 -h string:frcolor:#FFFFFF "$definition"

notify-send -h string:bgcolor:#FFFFFF -h string:fgcolor:#000000 -h string:frcolor:#FFFFFF "$examples"
